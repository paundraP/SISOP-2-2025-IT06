...
wait(NULL);
Kode ini mengekstrak Clues.zip langsung ke direktori saat ini tanpa menentukan folder tujuan (unzip Clues.zip) sehingga struktur direktori salah, menyebabkan langkah Filter gagal menemukan file di Clues/Clue*.
...
Masalahnya adalah tidak menampilkan isi Clues/Decoded.txt setelah decode, sehingga sulit memeriksa hasil. sehingga Tidak memenuhi kebutuhan soal untuk menampilkan hasil decode
